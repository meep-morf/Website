  ...
  return (
    ...
    >
      <div>
        ...
        <h2 className="mt-3 display-heading text-3xl md:text-4xl">{title}</h2>
      ...
      <div className="grid gap-8 sm:grid-cols-2">
        <div className="group rounded-sm border border-transparent p-1 transition-colors hover:border-border-subtle">
          <h3 className="mono-label mb-3">Problems we address</h3>
          <ul className="space-y-2 text-sm text-muted">
            {problems.map((item) => (
              <li
                key={item}
                className="border-l border-border pl-3 transition-colors group-hover:border-accent/40"
              >
                {item}
              </li>
            ))}
        ...
        <div className="group rounded-sm border border-transparent p-1 transition-colors hover:border-accent-border/30">
