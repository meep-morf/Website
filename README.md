...
.
├── Images/
│   ├── nomadlabz-logo-v3.png   (4K transparent lockup — nav, footer, preloader)
│   ├── nomadlabz-mark-v3.png   (NL monogram — favicon PNG)
│   └── nomadlabz-mark-v3.svg   (NL monogram — favicon SVG)
├── about.html
├── contact.html
├── index.html
├── main.js
